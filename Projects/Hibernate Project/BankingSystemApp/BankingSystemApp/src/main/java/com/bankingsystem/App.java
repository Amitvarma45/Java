...
//	}
	...
	public static void main(String[] args) {
		...
		case "u" -> {
			...
			updateAcc.setHolderName("Amit Varma");
			updateAcc.setAccbalance(60000);
			updateAcc.setEmail("AmitVarma@gmail.com");
		...
		case "da" -> dao.depositAmount(Integer.parseInt(JOptionPane.showInputDialog("enter id ", "type here")),
